package com.paulrybitskyi.gamedge.v2
...
import com.paulrybitskyi.gamedge.v2.ui.NiaApp
import com.paulrybitskyi.gamedge.v2.ui.rememberNiaAppState
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            val appState = rememberNiaAppState(
                ...
                uiProfileState = viewModel.state
            )

            CompositionLocalProvider(
                LocalUrlOpener provides urlOpener,
                LocalTextSharer provides textSharer,
            ) {
                NiaTheme(
                    darkTheme = darkTheme,
