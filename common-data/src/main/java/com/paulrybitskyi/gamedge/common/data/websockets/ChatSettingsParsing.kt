...
class ChatSettingsParsing {
    ...
    fun parseFollowerModeDurationValue(stringToParse: String): Int? {
        ...
        val followerModeDurationValue =
            followerModeDurationRegex.find(stringToParse)?.groupValues?.get(1)?.replace("\"", "") ?: ""
    ...
    fun parseSlowModeDurationValue(stringToParse: String): Int? {
        ...
        val slowModeDurationValue =
            slowModeDurationRegex.find(stringToParse)?.groupValues?.get(1)?.replace("\"", "") ?: ""
